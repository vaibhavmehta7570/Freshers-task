...
import { fetchUsersPostRequest, fetchUsersPostSuccess, fetchUsersCommentRequest, fetchUsersCommentSuccess } from "../actions/userPost"
...
describe('async actions', () => {
    ...
    it('creates FETCH_USERS_COMMENT_SUCCESS when fetching posts has been done', () => {
        ...
        const expectedActions = [
            fetchUsersCommentRequest(), fetchUsersCommentSuccess({ payload: [{ todos: ['do something'] }] })
        ]
        const store = mockStore({ todos: [] })
